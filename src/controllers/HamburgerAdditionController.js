  ...
  //	Delete a specific hamburger addition
	async delete(req, res) {
        ...
        try {
          ...
          return res.status(200).send("The hamburger addition and its thumbnail have been deleted!");
        } catch(e){
          return res.status(200).send("The hamburger addition have been deleted, but the thumbnail was not found");
        }
			} else {
				return res.status(400).send("Hamburger addition not found!");
			}
